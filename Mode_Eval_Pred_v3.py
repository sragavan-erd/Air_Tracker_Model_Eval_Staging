...
mDATE = cDATE.astimezone(mountain).replace(minute=0,
...
mwm = get_mesowest_radius(cDATE, '40.65,-112.0', '20',
                          '30', hrrr_vars, extra='', set_num=0, verbose=True) 
...
os.remove('/tmp/hrrr') #Removing the ARL files downloaded in the previous step, presumably to preserve storage space
